...
@Component({
  selector: 'app-edit-grow-money',
  templateUrl: './edit-grow-money.component.html',
  styleUrls: ['./edit-grow-money.component.css', '../../component/common/ng-style/ng-style.component.css']
})
export class EditGrowMoneyComponent implements OnInit {
  ...
  isEmployee = new FormControl('no', [Validators.required]);
  mobilePrefix1 = true;

  constructor(public dialogRef: MatDialogRef<EditGrowMoneyComponent>) { }
  ...
  getErrorMessageYourAge() {
    return this.yourAge.hasError('required') ? 'Please enter your age' : '';
  }
