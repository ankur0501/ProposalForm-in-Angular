...
@Component({
  selector: 'app-edit-child-future',
  templateUrl: './edit-child-future.component.html',
  styleUrls: ['./edit-child-future.component.css', '../../component/common/ng-style/ng-style.component.css']
})
export class EditChildFutureComponent implements OnInit {
  ...
  childAge = new FormControl('12', [Validators.required]);
  ...
  constructor(public dialogRef: MatDialogRef<EditChildFutureComponent>) { }
  ...
  getErrorMessageChildAge() {
    return this.childAge.hasError('required') ? 'Please enter your child age' : '';
  }
